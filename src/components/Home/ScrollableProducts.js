      ...
      style={{marginTop: 5}}>
        {
          ...
          datas.map((hit)=>{
            return <TouchableOpacity onPress={() => navigation.navigate('SingleMealScreen')} key={hit.id}>
            <View style={{margin: 5}} >
              <Image
              ...
              <View style={{marginTop: 5}}>
                <Text style={styles.randomScrollableProductHead}>{hit.meal_name.slice(0,17)}...</Text>
                <Text style={styles.randomScrollableProductPara}>
                 {hit.category_name}
                </Text>
    
                <View
                  style={{flexDirection: 'row', marginTop: 20, marginBottom: 30}}>
                  <Text
                    style={{
                      color: '#333333',
                      marginTop: 9,
